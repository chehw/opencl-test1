...
void opencl_variable_clear(struct opencl_variable * var)
{
	...
	#define OPENCL_DEVICE_INFO_LAST_ITEM	CL_DEVICE_SUB_GROUP_INDEPENDENT_FORWARD_PROGRESS
#else
	#ifdef CL_VERSION_1_2
		#define OPENCL_DEVICE_INFO_LAST_ITEM	CL_DEVICE_IMAGE_BASE_ADDRESS_ALIGNMENT
	#else
		#define OPENCL_DEVICE_INFO_LAST_ITEM 	CL_DEVICE_OPENCL_C_VERSION
	#endif
#endif
